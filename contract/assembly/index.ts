...
const ContractArray = new PersistentUnorderedMap<string,string[]>("array of contracts ");
...
export function getContractPair(contract:string):string[]{
  if(CandidatePair.contains(contract)){
    return CandidatePair.getSome(contract)
  }else{
    logging.log('contract not found')
    return []
  }
}

export function getAllContracts():string[]{
    return ContractArray.keys()
}
...
export function addToContractArray(contract:string,prompt:string):void{
  logging.log('added to contract array')
  if(ContractArray.contains(contract)){
    logging.log('add addition to contract array')
    let tempArray=ContractArray.getSome(contract)
    tempArray.push(prompt)
    ContractArray.set(contract,tempArray);
  }else{
    ContractArray.set(contract,[prompt])
...
// export function getContract(contract:string):string[]{
//   if(ContractArray.contains(contract)){
//     return ContractArray.getSome(contract)
//   }else{
//     logging.log('contract not found')
//     return []
//   }
...
// export function addToContractArray(contract:string,prompts:string):void{
//   logging.log('added to contract array')
//   if(ContractArray.contains(contract)){
//     logging.log('add addition to contract array')
//     let tempArray=ContractArray.getSome(contract)
...
//     ContractArray.set(contract,tempArray);
//   }else{
//     ContractArray.set(contract,[prompts])
//   }
// }
